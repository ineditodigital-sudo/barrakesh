    ...
    return (
        <div className="space-y-6 animate-fade-in-up pb-10">
                        ...
                        <div className="flex-1 flex flex-col justify-between py-0.5">
                            <div>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <span className={`text-[8px] font-bold uppercase tracking-widest ${isDarkMode ? 'text-white/20' : 'text-black/40'}`}>Sede</span>
            ...
            <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
                <div
                    className={`relative ios-card p-6 w-full max-w-lg animate-scale-in transition-colors ${isDarkMode ? 'bg-[#121212]' : 'bg-white'} ${!isDarkMode ? 'shadow-2xl' : ''}`}
                >
                    <div className="flex justify-between items-center mb-6">
                        <h3 className={`text-xl font-bold tracking-tight ${isDarkMode ? 'text-white' : 'text-black'}`}>{currentBranch ? 'Ajustes de Sede' : 'Alta de Sucursal'}</h3>
